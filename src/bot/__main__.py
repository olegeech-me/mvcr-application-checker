...
from bot.handlers import unsubscribe_command, subscribe_command, admin_stats_command, info_callback
...
async def main():
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            LANG: [CallbackQueryHandler(set_language_startup, pattern="set_lang_startup_*")],
            INFO: [CallbackQueryHandler(info_callback)],
